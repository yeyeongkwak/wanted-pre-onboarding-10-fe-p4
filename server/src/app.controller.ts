import {Body, Controller, Get, HttpException, Param, Post, Put, Request, UseGuards} from '@nestjs/common'
...
export class AppController {
    ...
    @UseGuards(AuthenticatedGuard)
    @Put('/user/edit')
    async updateUserInfo(@Param('userId') userId, @Body() updateReq) {
        return this.usersService.updateUser(userId, updateReq)
    }
